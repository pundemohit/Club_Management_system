          ...
          if(isset($_GET['id'])){
            ...
            <form action="code.php" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" value="<?=$student['department'];?>" name="department" class="form-control" id="">
              </div>
              <div class="mb-3">
                <label for="">Student Position</label>
                <input type="text" value="<?=$student['position'];?>" name="position" class="form-control" id="">
              </div>
              <div class="mb-3">
